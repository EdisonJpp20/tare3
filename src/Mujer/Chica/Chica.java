...
public class Chica extends  Mujer{
    private String padre ;
    private String madre ;

    public Chica(String nombre, int edad, String colorDePiel, String esposo, String trabajo, String padre , String madre, String familia) {
